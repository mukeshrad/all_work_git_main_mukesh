...
class PaymentReceived extends StatefulWidget {
  ...
  const PaymentReceived(
      {Key? key, required this.paymenData, required this.isFrome})
      : super(key: key);
              ...
              Column(
                children: [
                  Container(
                      ...
                      child: const Text("Payment Received Successfully",
                  ...
                  Container(
                    ...
                    child: const Text("Transaction Successfull",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            color: appBlackColor,
                            fontSize: 16,
