          ...
          children: [
              ...
              child: Column(
                children: [
                  Container(
                      ...
                      child: const Text("Payment Request Sent Successfully",
                  ...
                  Container(
                    ...
                    child: const Text(
                        "Kindly open your Payment Application , as the request for the Payment has been sent to it.",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            color: appBlackColor,
                            fontSize: 16,
            ...
            Container(
              child: Row(
                ...
                children: [
                  Text(
                      counter != totalSecondsExpire
                          ? "The Payment Link will expire in  "
                  ...
                  Text(
                      counter != totalSecondsExpire
                          ? (totalSecondsExpire - counter).toString() + " Sec."
                          : "",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: appBlackColor,
            ...
            TextButton(
              ...
              child: Container(
                ...
                margin: const EdgeInsets.only(
                    left: 25, right: 25, bottom: 30, top: 5),
