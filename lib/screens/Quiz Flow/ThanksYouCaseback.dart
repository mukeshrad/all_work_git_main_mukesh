          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Image.asset("assets/images/verifyed.png",width: 64,height: 64,),
              ),
              ...
              Container(
                  ...
                  alignment: Alignment.center,
                  child: const Text("Thank You!",textAlign: TextAlign.center,style: TextStyle(color: appBlackColor,fontSize: 24,fontWeight: FontWeight.bold))),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        alignment: Alignment.center,
                        child: Text("₹ 10",textAlign: TextAlign.center,style: TextStyle(color: appBlackColor,fontSize: 60,fontWeight: FontWeight.bold)
                          ,))
